...
public:
	...
	/*
	* The following components use the template function
	* - The Template function allows for any data type to passed into the function
	* - typename T is used to define the component type
	* - typename... Targs allows for multiple paramaters to be passed in
	*
	* i.e. this is called - add_component<SpriteComponent>("player.png", 64, 64);
	* this would become - std::make_shared<SpriteComponent>(this, "player.png", 64, 64);
	*
